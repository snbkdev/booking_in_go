...
func TestForm_MinLength(t *testing.T) {
	...
	form.MinLength("x", 10)
	if form.Valid() {
		t.Error("Form shows MinLength for none existing field")
	}
	...
	if form.Valid() {
		t.Error("shows min lenth of 100 met when data is shorter")
	}
...
func TestForm_IsEmail(t *testing.T) {
	...
	form.IsEmail("x")
	if form.Valid() {
		t.Error("form shows valid email for none existent field")
	}
